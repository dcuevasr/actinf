...
class betMDP():
    def __init__(self, kolling = False):
        """
    ...
    def setActionPairs(self):
        ...
        if self.paradigm == 'small':
            ...
            nP = 8
            pL = np.array([90, 60, 75, 55, 90, 60, 75, 80])/100
            pH = np.array([35, 35, 35, 20, 45, 45 ,40, 30])
            rL = np.array([100, 180, 145, 145, 115, 150, 170, 120])/100
...
#        return nP, pL, pH, rL, rH
    ...
    def setMDPMultVar(self,parameters=None):    
        ...
        MDP['lambda'] = 0.005 # or 1/4?
        MDP['gamma'] = 20
#        MDP['ActionPairs'] = {'nP':nP,'pL':pL,'pH':pH,'rL':rL,'rH':rH}
